...
public class AppDbSettings extends DefaultSettingsEntity implements AppSettings {
  ...
  public static class Meta extends DefaultSettingsEntityType {
    ...
    private static final String GOOGLE_ANALYTICS_ACCOUNT_PRIVACY_FRIENDLY_SETTINGS =
        "ga_acc_privacy_friendly";
    private static final String GOOGLE_ANALYTICS_TRACKING_ID_MOLGENIS = "ga_tracking_id_mgs";
    private static final String GOOGLE_ANALYTICS_ACCOUNT_PRIVACY_FRIENDLY_SETTINGS_MOLGENIS =
        "ga_acc_privacy_friendly_mgs";
    ...
    public void init() {
      ...
      addAttribute(CUSTOM_JAVASCRIPT)
          .setDataType(TEXT)
          .setNillable(true)
      ...
      addAttribute(GOOGLE_ANALYTICS_IP_ANONYMIZATION)
      ...
      addAttribute(GOOGLE_ANALYTICS_TRACKING_ID)
          .setParent(trackingAttr)
          .setDataType(STRING)
          .setNillable(true)
      ...
      addAttribute(TRACKING_CODE_FOOTER)
          .setParent(trackingAttr)
          .setDataType(SCRIPT)
          .setNillable(true)
